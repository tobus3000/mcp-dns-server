...
class TestSOAConsistency:
    ...
    def test_check_soa_consistency_returns_dict(self):
        ...
        with patch(
            "dns_mcp_server.tools.validator.dnssec._resolver.resolve"
        ) as mock_resolve:
            soa_rdata = MagicMock()
...
class TestKeyInspection:
    ...
    def test_inspect_keys_and_rollover_with_key(self):
        ...
        with patch(
            "dns_mcp_server.tools.validator.dnssec.key_tag_from_dnskey",
            return_value=12345,
        ):
...
class TestFullValidationWorkflow:
    ...
    def test_validate_domain_structure(self):
        ...
        with patch(
            "dns_mcp_server.tools.validator.dnssec._resolver.fetch_dnskey"
        ) as mock_fetch:
                ...
                with patch(
                    ...
                    with patch(
                        ...
                        with patch(
                            ...
                            with patch(
                                "dns_mcp_server.tools.validator.dnssec.check_robustness"
                            ):
...
class TestErrorHandling:
    ...
    def test_check_parent_ds_with_mock_resolver(self):
        ...
        with patch(
            "dns_mcp_server.tools.validator.dnssec._resolver.fetch_ds"
        ) as mock_fetch:
            mock_fetch.return_value = (None, None)
...
class TestIntegration:
    ...
    def test_full_validation_workflow_mocked(self):
        ...
        with patch(
            ...
            with patch(
                "dns_mcp_server.tools.validator.dnssec.check_parent_ds"
            ) as mock_parent:
                with patch(
                    "dns_mcp_server.tools.validator.dnssec.check_rrset_signature"
                ) as mock_sig:
